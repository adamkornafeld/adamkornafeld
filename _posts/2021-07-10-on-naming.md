...
article_header:
  ...
  background_image:
    src: https://www.dalipaintings.com/assets/img/paintings/the-persistence-of-memory.jpg
---
...
Apart from being able to wind this clock back into the past or forward into the future - or [back to the future](https://youtu.be/VLKDKWCWVXc?t=25) 😉 -, it will tick as you expect a regular clock to tick - once every second.
...
The latter will yield nondeterministic results. The test will work most of the time, but every once in a while results might be flaky due to tiny nanosecond differences:
